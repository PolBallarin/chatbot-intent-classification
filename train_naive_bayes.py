#!/usr/bin/env python3
"""
Entrenamiento de Naive Bayes + TF-IDF para clasificación de intents.
Modelo probabilístico baseline.
"""
...
with open("results/naive_bayes_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("\n✅ Modelo guardado en models/naive_bayes_model.pkl")
print("✅ Resultados guardados en results/naive_bayes_results.json")
