#!/usr/bin/env python3
"""
Entrenamiento de Random Forest + TF-IDF para clasificación de intents.
Modelo ensamble clásico.
"""
...
with open("results/random_forest_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("\n✅ Modelo guardado en models/random_forest_model.pkl")
print("✅ Resultados guardados en results/random_forest_results.json")
